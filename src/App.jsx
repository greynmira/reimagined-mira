  ...
  return (
    <section className="closing">
      <div className="closing__inner">
        <h2 className="section-headline" style={{color: 'var(--color-green)'}}>Enough Thinking</h2>
        <p>You&apos;ve spent enough time on this website. I&apos;ve spent enough time writing it.</p>
        <p style={{marginTop: '32px'}}><a href={CALENDLY_URL} target="_blank" rel="noopener noreferrer">Book a free call</a> and let&apos;s have a conversation. There is no pressure or obligation to work together.</p>
