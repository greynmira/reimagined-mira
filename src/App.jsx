  ...
  return (
    <section className="why-started">
      <div className="why-started__inner">
        ...
        <p><strong className="why-started__hook">I&apos;m obsessed with career strategy.</strong><br />Positioning, networking, personal brand, and career growth. <em>I dream about this stuff so you don&apos;t have to.</em></p>
        ...
        <p>What I&apos;ve learned is that most people aren&apos;t lacking talent. They&apos;re lacking perspective, accountability, and a trusted sounding board.</p>
