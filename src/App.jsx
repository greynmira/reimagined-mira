  ...
  return (
    <section className="closing">
      <div className="closing__inner">
        ...
        <p>You&apos;ve spent enough time reading this website.<br />Trust me, I&apos;ve spent enough time writing it.<br /><br /><a href={CALENDLY_URL} target="_blank" rel="noopener noreferrer">Book a free discovery call</a>, talk to a real human, and take a real step toward change.<br /><br /><strong className="why-started__hook">I&apos;m ready. Are you?</strong></p>
      </div>
    </section>
  )
}
