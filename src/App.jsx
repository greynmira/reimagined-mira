      ...
      <div className="hero__inner">
        <div className="hero__content">
          ...
          <p className="hero__subtext">
            You need someone who will push back on the story you&apos;ve been telling yourself. Together, we&apos;ll build a strategy that&apos;s thoughtful, practical, and tailored to you.
          </p>
  ...
  return (
    <section className="why-started">
      <div className="why-started__inner">
        ...
        <p>After reinventing my own career, from business school to clinical nutrition, and ultimately Digital Health, I realized meaningful growth rarely comes from just working harder. It comes from thinking strategically about where you can create the greatest impact.</p>
  ...
  return (
    <section className="testimonials">
      <div className="testimonials__inner">
        <h2 className="section-headline">Different Careers,<br />Shared Clarity</h2>
