  ...
  return (
    <section className="why-started">
      <div className="why-started__inner">
        ...
        <p>I&apos;m obsessed with career strategy.<br />Positioning, networking, personal brand, and career growth. <strong className="why-started__hook">I dream about this stuff so you don&apos;t have to.</strong></p>
        ...
        <p>What I&apos;ve learned is that most people aren&apos;t lacking talent. Commonly they are instead lacking perspective, accountability, and a trusted sounding board.</p>
